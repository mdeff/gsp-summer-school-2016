...
The irregular nature of the modeled structures makes classical signal processing
concepts often only partially true. The main similarities and differences
between classical signal processing and GSP will be presented.

Examples of theoretical topics to be showcased include graph fundamental limits
