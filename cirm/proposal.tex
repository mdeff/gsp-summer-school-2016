...
We will invite five speakers to give lectures. We expect one of them, the first
to present on Monday, to introduce the field and give a motivational talk. The
goal is for novice attendants to be able to follow the more advanced talks.
Speakers are selected such that all of those three non-overlapping tracks are
covered.
