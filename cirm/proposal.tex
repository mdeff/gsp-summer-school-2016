...
to CIRM for a short lecture, we envision to introduce a ''side track`` about
optimization, which is quite relevant to GSP. We however won't contact those
speakers yet, as it may not happen should this proposal be rejected (because the
event may then be located in another place with a different local
configuration).
...
that we have tow years to advertise it.
\begin{itemize}
\setlength{\itemsep}{0pt} \setlength{\parskip}{0pt}
\item TRACK 1
	\begin{itemize}
	...
	\item \href{http://ee.usc.edu/faculty_staff/faculty_directory/ortega.htm}
		...
		% Mauro: could talk a lot about a variety of applications
...
Depending on the enthusiasm of the community, notably at GSP2016\footnote{To be
held in May 2016 in Pennsylvania.}, this event may grow in size (in terms of
speakers and attendants) and become a mix of long tutorial lectures and short
lectures (like in workshops).
...
\begin{table}[ht]
	...
	\hline
	\multicolumn{3}{|l|}{\textbf{Total}} & \textbf{28'248} \\
	\hline
	\end{tabular}
