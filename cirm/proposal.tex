...
talks. 
We organize the lessons into 3 different non-overlapping tracks:
\begin{itemize}
	\setlength{\itemsep}{0pt} \setlength{\parskip}{0pt}
	\item Introduction to graph signal processing (TRACK 1)
	\item Origins of graph signal processing (TRACK 2)
	\item Innovations and applications of graph signal processing (TRACK 3)
 \end{itemize} 
We will select the speakers such that all tracks are widely covered.

Below is the list of speakers we contacted to lecture at this school. As
we don't know yet the date and place of the school, we didn't asked them to
confirm their venue.
% pre-confirmed their attendance
\begin{itemize}
	\setlength{\itemsep}{0pt} \setlength{\parskip}{0pt}
	\item \href{http://people.epfl.ch/pierre.vandergheynst}
		{Pierre Vandergheynst}, EPFL, Switzerland (TRACK 1)
		% Signal processing on graphs
\end{itemize}

In case the aforementioned speakers cannot make it, below is another list of
potential ones. The diversity of this school is again reflected in the broad
range of considered speakers. 
\paragraph{TRACK 1: Introduction to graph signal processing}
\begin{itemize}
	\setlength{\itemsep}{0pt} \setlength{\parskip}{0pt}
...
\paragraph{TRACK 2: Origins of graph signal processing}
\begin{itemize}
	\setlength{\itemsep}{0pt} \setlength{\parskip}{0pt}
...
\paragraph{TRACK 3: Innovations and applications of graph signal processing}
\begin{itemize}
	\setlength{\itemsep}{0pt} \setlength{\parskip}{0pt}
