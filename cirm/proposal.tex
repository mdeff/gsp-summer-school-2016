...
\begin{itemize}
	...
	\item Risi kondor
	\item Jure Leskovec
	\item Ulrike von Luxburg, University of Tuebingen, Germany
...
To the best of our knowledge, Fan Chung Graham and Jelena Kovačević are the only
women professors in the field. As for the participants we cannot comment on
every lab but at EPFL the gender parity is comparable to other events in the
field with 20 women for 70 men in the labs of Prof. Vandergheynst, Frossard,
Thiran and Grossglauser.
